...
export const CuratedCollection = () => {
  return (
    <>
      <Background src="/images/contact-us-header-background.webp" alt="contact us background" className="flex items-center justify-center min-h-500 bg-light/20">
        <div className="w-full max-w-screen-xl px-4 space-y-8 sm:px-8">
