    ...
    <>
      <Motion tag="div" initialY={0} animateY={0} duration={0.3} className="mx-auto space-y-12 text-gray max-w-screen-2xl">
        <div className="flex flex-col-reverse gap-4 px-4 overflow-hidden sm:gap-6 sm:px-0 sm:flex-row">
          ...
          <Img src={title1_image1} alt={`${formatSpaceToDash(title1)}-description-list-1`} className="w-full mx-auto max-w-96 min-h-300 sm:min-h-400 md:min-h-500" cover />
          <div className="hidden w-full max-w-96 md:block">
            <Img src={title1_image2} alt={`${formatSpaceToDash(title1)}-description-list-2`} className="w-full max-w-96 min-h-500" cover />
          </div>
          <div className="hidden w-full max-w-44 xl:block">
            <Img src={title1_image3} alt={`${formatSpaceToDash(title1)}-description-list-3`} className="w-full max-w-44 min-h-500" cover />
          </div>
        </div>
      </Motion>
      <Motion tag="div" initialY={0} animateY={0} duration={0.3} className="mx-auto space-y-12 text-gray max-w-screen-2xl">
        <div className="flex flex-col gap-4 px-4 overflow-hidden sm:gap-6 sm:px-0 sm:flex-row">
          <div className="hidden w-full max-w-44 xl:block">
            <Img src={title2_image1} alt={`${formatSpaceToDash(title1)}-description-list-1`} className="w-full max-w-44 min-h-500" cover />
          </div>
          <div className="hidden w-full max-w-96 md:block">
            <Img src={title2_image2} alt={`${formatSpaceToDash(title1)}-description-list-2`} className="w-full max-w-96 min-h-500" cover />
          </div>
          <Img src={title2_image3} alt={`${formatSpaceToDash(title1)}-description-list-3`} className="w-full mx-auto max-w-96 min-h-300 sm:min-h-400 md:min-h-500" cover />
          <div className="flex flex-col items-center justify-center w-full max-w-lg gap-2 text-center sm:gap-4">
            <div className="space-y-1">
            ...
            <Link href="/lure-by-lindway" className="block pb-1 text-sm font-medium border-b sm:text-lg border-gray w-max">
              Discover Now
            </Link>
          </div>
        </div>
