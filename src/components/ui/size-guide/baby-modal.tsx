...
export const BabyModal = ({ isVisible, onClose }: { isVisible: boolean; onClose: () => void }) => {
  ...
  return (
    <Modal isVisible={isVisible} onClose={onClose}>
      <h4 className="mb-4 text-center heading">Baby and Kids Size Guide</h4>
      <div className="max-w-2xl py-4 mx-auto space-y-6 bg-light">
        <div className="flex justify-center mb-6 border-b border-gray">
          <p className={`px-4 py-2 font-medium text-sm border-b-2 transition-colors border-transparent text-gray`}>Soft, breathable cotton tees designed for our littlest customers</p>
        </div>
