  ...
  return (
    <Background src="/images/size-guide-header-background.webp" alt="hero background" className="flex flex-col items-center min-h-600 bg-filter">
      ...
      <Container className="pt-24 space-y-4 text-center sm:text-justify md:pt-32">
        ...
        <Motion tag="p" initialY={50} animateY={0} duration={0.6} delay={0.1} className="max-w-screen-lg text-sm sm:text-base md:text-lg">
        ...
        <Motion tag="p" initialY={50} animateY={0} duration={0.6} delay={0.2} className="max-w-screen-lg text-sm sm:text-base md:text-lg">
