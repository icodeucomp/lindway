    ...
    <>
      <Container className="pt-12 space-y-8 sm:pt-14 md:pt-16">
        ...
        <Motion tag="div" initialX={0} animateX={0} duration={0.3} className="grid grid-cols-1 gap-8 mx-auto md:gap-0 md:grid-cols-3 text-light">
          <Background src="/images/size-guide-find-your-perfect-fit-women-measurement.webp" alt="women hero background" className="flex items-end justify-center p-8 min-h-400 sm:min-h-600 bg-dark/40">
          ...
          <Background src="/images/size-guide-find-your-perfect-fit-men-measurement.webp" alt="men hero background" className="flex items-end justify-center p-8 min-h-400 sm:min-h-600 bg-dark/40">
            <div className="space-y-4 text-center">
          ...
          <Background src="/images/size-guide-find-your-perfect-fit-baby-measurement.webp" alt="baby hero background" className="flex items-end justify-center p-8 min-h-400 sm:min-h-600 bg-dark/40">
            <div className="space-y-4 text-center">
          ...
          <Background
            ...
            className="flex items-center justify-center p-8 min-h-300 lg:min-h-400 bg-dark/40"
