...
export const PaymentStep = ({ formData, setFormData, price, parameter, onBack, onSubmit, isLoading }: PaymentStepProps) => {
      ...
      <div className="space-y-3 sm:space-y-4">
        ...
        >
          <div className="flex items-center gap-3 sm:gap-4">
            <FaQrcode size={20} className="flex-shrink-0 text-blue-500" />
        ...
        >
          <div className="flex items-center gap-3 sm:gap-4">
            <FaCreditCard size={20} className="flex-shrink-0 text-green-500" />
            <div className="min-w-0">
