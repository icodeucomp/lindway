...
export const Hero = () => {
  return (
    <Background src="/images/about-lindway-header-background.webp" alt="hero background" className="flex flex-col items-center min-h-700 md:min-h-screen bg-filter">
      <Header />
      <Container className="flex flex-col items-center gap-8 pt-16 pb-10 md:pb-0 md:flex-row lg:gap-16">
        <Img
          ...
          alt="hero image"
          className="w-full mx-auto min-w-80 max-w-80 sm:max-w-96 min-h-80 sm:min-h-400 lg:min-h-500"
          cover
          position="top"
        />
