...
export const AboutUs = () => {
  return (
    <Container className="py-12 space-y-20 md:space-y-24 lg:py-16 text-gray">
      ...
      <Motion tag="div" initialY={30} animateY={0} duration={1} className="hidden w-full gap-8 lg:flex min-h-700">
        <Img src="/images/about-lindway-lindway-philosophy-kiri.webp" alt="hero image" className="w-full max-w-80 xl:max-w-sm min-w-80 min-h-500 max-h-fit" cover />
        <div className="text-sm text-justify">
          ...
          <div className="flex items-center justify-between gap-8 xl:gap-16">
            <Img src="/images/about-lindway-lindway-philosophy-kanan.webp" alt="hero image" className="w-full max-w-80 xl:max-w-sm min-w-80 min-h-500" cover />
      ...
      <Motion tag="div" initialY={30} animateY={0} duration={1} className="block space-y-8 text-center lg:hidden">
        ...
        <div className="flex">
          <Img src="/images/about-lindway-lindway-philosophy-kiri.webp" alt="hero image" className="w-full min-h-300 sm:min-h-400 md:min-h-500" cover />

          <Img src="/images/about-lindway-lindway-philosophy-kanan.webp" alt="hero image" className="w-full min-h-300 sm:min-h-400 md:min-h-500" cover />
        </div>
        <div className="space-y-2 text-center">
