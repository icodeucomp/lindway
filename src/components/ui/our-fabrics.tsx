    ...
    <div className="pt-8 md:pt-16">
      ...
      <div className="max-w-4xl px-4 py-8 mx-auto space-y-4 text-center md:space-y-8">
        ...
        <Motion tag="div" initialY={50} animateY={0} duration={0.5} delay={0.1} className="grid max-w-xl grid-cols-3 gap-2 mx-auto md:gap-4">
          <Img src="/images/our-fabric-crafted-by-hand-image-1.webp" alt="crafted image 1" className="w-full min-h-64 sm:min-h-300" cover />
          <Img src="/images/our-fabric-crafted-by-hand-image-2.webp" alt="crafted image 2" className="w-full min-h-64 sm:min-h-300" cover />
          <Img src="/images/our-fabric-crafted-by-hand-image-3.webp" alt="crafted image 3" className="w-full min-h-64 sm:min-h-300" cover />
        </Motion>
      </div>
      ...
      <div className="space-y-4 md:space-y-8">
        ...
        <Motion tag="div" initialY={50} animateY={0} duration={0.5} delay={0.1} className="grid grid-cols-2 px-4 sm:px-0">
          <Img src="/images/our-fabric-thoughtfully-image-1.webp" alt="Thoughtfully image 1" className="w-full min-h-64 sm:min-h-300 md:min-h-400" cover />
          <Img src="/images/our-fabric-thoughtfully-image-2.webp" alt="Thoughtfully image 2" className="w-full min-h-64 sm:min-h-300 md:min-h-400" cover />
        </Motion>
      </div>
    </div>
  );
